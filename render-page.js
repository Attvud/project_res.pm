...
exports.ssrComponents = {
  ...
  "component---src-components-project-res-pm-pages-index-js": preferDefault(__webpack_require__(/*! ./src/components/project/res.pm/pages/index.js */ "./src/components/project/res.pm/pages/index.js"))
  }
...
var plugins = [{
  ...
  options: {
    "plugins": [],
    "name": "Artem Attvud | Lead UX/UI Designer & Middle Web Developer",
    "short_name": "Artem A.",
    "icon": "content/res.pm/static/images/icon-maskable.png",
    "icon_options": {
    ...
    "cacheDigest": "c390dce2e48cd5189b41b28b04208975"
  }
}, {
  ...
  options: {
    "plugins": [],
    "precachePages": ["/index", "/resume", "/portfolio", "/contacts"],
    "workboxConfig": {
      "runtimeCaching": [{
        "urlPattern": {},
        "handler": "CacheFirst"
  ...
  options: {
    ...
    "root": "D:\\projects\\_source code\\gatsby-sites"
  }
}, {
  ...
  options: {
    ...
    "exclude": ["/dev-404-page", "/404", "/404.html", "/offline-plugin-app-shell-fallback", "/my-excluded-page"],
...
/***/ "./src/components/global/atoms/Button/index.js":
/*!*****************************************************!*\
  !*** ./src/components/global/atoms/Button/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/index.scss */ "./src/components/global/atoms/Button/styles/index.scss");
/* harmony import */ var _styles_index_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_styles_index_scss__WEBPACK_IMPORTED_MODULE_1__);


function Button(props) {
  var _props$value, _props$type;

  const isIconButton = react__WEBPACK_IMPORTED_MODULE_0___default().Children.count(props.children) === 0 ? true : false; // HTML tag definition
  ...
  const variant = props.variant ? getVariant(props.variant) : "btn-filled-blue";
  const size = getSize(props.size, props.as, isIconButton);
  const borders = getBorders(props.className);
  const disabled = props.disabled ? "disabled" : "";
  const transparent = props.transparent ? "btn-transparent" : "";
  const block = props.block ? "btn-block" : "";
  const inputValue = (_props$value = props.value) !== null && _props$value !== void 0 ? _props$value : "Input button";
  const type = (_props$type = props.type) !== null && _props$type !== void 0 ? _props$type : "button"; // Generate class list

  let classList = `btn ${size} ${borders} ${disabled} ${transparent} ${block} ${variant}${className}`;
  ...
  switch (props.as) {
    case "input":
      ...
      }, props.leftIcon, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
        type: type,
        value: inputValue
      }), props.rightIcon);
...
function getVariant(variant) {
  switch (variant) {
    // Filled buttons
    case "red":
      return "btn-filled-red";

    case "orange":
      return "btn-filled-orange";

    case "yellow":
      return "btn-filled-yellow";

    case "green":
      return "btn-filled-green";

    case "teal":
      return "btn-filled-teal";

    case "blue" || 0:
      return "btn-filled-blue";

    case "indigo":
      return "btn-filled-indigo";

    case "purple":
      return "btn-filled-purple";

    case "pink":
      return "btn-filled-pink";

    case "gray":
      return "btn-filled-gray";
    // Outlined buttons

    case "outlined-red":
      return "btn-outlined-red";

    case "outlined-orange":
      return "btn-outlined-orange";

    case "outlined-yellow":
      return "btn-outlined-yellow";

    case "outlined-green":
      return "btn-outlined-green";

    case "outlined-teal":
      return "btn-outlined-teal";

    case "outlined-blue" || 0:
      return "btn-outlined-blue";

    case "outlined-indigo":
      return "btn-outlined-indigo";

    case "outlined-purple":
      return "btn-outlined-purple";

    case "outlined-pink":
      return "btn-outlined-pink";

    case "outlined-gray":
      return "btn-outlined-gray";
  }
}

function getSize(size, tagName, isIconButton) {
  let buttonSize;
  if (size === "lg") buttonSize = "btn-large";
  if (size === "md") buttonSize = "btn-medium";
  if (size === "sm") buttonSize = "btn-small";
  if (!size) buttonSize = "btn-medium";
  if (size === "lg" && isIconButton === true && tagName !== "input") buttonSize = "btn-icon-large";
  if (size === "md" && isIconButton === true && tagName !== "input") buttonSize = " btn-icon-medium";
  if (size === "sm" && isIconButton === true && tagName !== "input") buttonSize = "btn-icon-small";
  if (!size && isIconButton === true && tagName !== "input") buttonSize = "btn-icon-medium";
  return buttonSize;
}

function getBorders(className) {
  if (className === undefined || className.indexOf("rounded" !== -1)) {
    return "rounded";
  }
...
/***/ "./src/components/global/atoms/Icon/index.js":
/*!***************************************************!*\
  !*** ./src/components/global/atoms/Icon/index.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.scss */ "./src/components/global/atoms/Icon/styles.scss");
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_styles_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib */ "./src/components/global/atoms/Icon/lib/index.js");



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().memo(function Icon(props) {
  var _props$size, _props$category, _props$icon;

  const size = (_props$size = props.size) !== null && _props$size !== void 0 ? _props$size : "24";
  const category = (_props$category = props.category) !== null && _props$category !== void 0 ? _props$category : "material";
  const icon = (_props$icon = props.icon) !== null && _props$icon !== void 0 ? _props$icon : "add_circle";
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
    className: "icon",
    id: props.id,
    disabled: props.disabled
  }, props.onClick && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, _lib__WEBPACK_IMPORTED_MODULE_2__[category][icon]));
}));

/***/ }),

/***/ "./src/components/global/atoms/Icon/lib/index.js":
/*!*******************************************************!*\
  !*** ./src/components/global/atoms/Icon/lib/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _material_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./material/action */ "./src/components/global/atoms/Icon/lib/material/action.js");
/* harmony import */ var _material_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./material/content */ "./src/components/global/atoms/Icon/lib/material/content.js");
/* harmony import */ var _material_navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./material/navigation */ "./src/components/global/atoms/Icon/lib/material/navigation.js");



const material = Object.assign(_material_action__WEBPACK_IMPORTED_MODULE_0__.action, _material_content__WEBPACK_IMPORTED_MODULE_1__.content, _material_navigation__WEBPACK_IMPORTED_MODULE_2__.navigation);

/***/ }),

/***/ "./src/components/global/atoms/Icon/lib/material/action.js":
/*!*****************************************************************!*\
  !*** ./src/components/global/atoms/Icon/lib/material/action.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const action = {
  account_circle: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"
  }),
  check_circle: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.29 16.29L5.7 12.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.59 7.59c-.38.39-1.02.39-1.41 0z"
  }),
  delete: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"
  }),
  done: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  favorite: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  home: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M10 19v-5h4v5c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-7h1.7c.46 0 .68-.57.33-.87L12.67 3.6c-.38-.34-.96-.34-1.34 0l-8.36 7.53c-.34.3-.13.87.33.87H5v7c0 .55.45 1 1 1h3c.55 0 1-.45 1-1z"
  }),
  info: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  search: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M15.5 14h-.79l-.28-.27c1.2-1.4 1.82-3.31 1.48-5.34-.47-2.78-2.79-5-5.59-5.34-4.23-.52-7.79 3.04-7.27 7.27.34 2.8 2.56 5.12 5.34 5.59 2.03.34 3.94-.28 5.34-1.48l.27.28v.79l4.25 4.25c.41.41 1.08.41 1.49 0 .41-.41.41-1.08 0-1.49L15.5 14zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"
  }),
  settings: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  shopping_cart: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 3c0 .55.45 1 1 1h1l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h11c.55 0 1-.45 1-1s-.45-1-1-1H7l1.1-2h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.67-1.43c-.16-.35-.52-.57-.9-.57H2c-.55 0-1 .45-1 1zm16 15c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"
  }),
  visibility: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 4C7 4 2.73 7.11 1 11.5 2.73 15.89 7 19 12 19s9.27-3.11 11-7.5C21.27 7.11 17 4 12 4zm0 12.5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"
  }),
  description: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  face: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  favorite_border: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  fingerprint: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  help_outline: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-4h2v2h-2zm1.61-9.96c-2.06-.3-3.88.97-4.43 2.79-.18.58.26 1.17.87 1.17h.2c.41 0 .74-.29.88-.67.32-.89 1.27-1.5 2.3-1.28.95.2 1.65 1.13 1.57 2.1-.1 1.34-1.62 1.63-2.45 2.88 0 .01-.01.01-.01.02-.01.02-.02.03-.03.05-.09.15-.18.32-.25.5-.01.03-.03.05-.04.08-.01.02-.01.04-.02.07-.12.34-.2.75-.2 1.25h2c0-.42.11-.77.28-1.07.02-.03.03-.06.05-.09.08-.14.18-.27.28-.39.01-.01.02-.03.03-.04.1-.12.21-.23.33-.34.96-.91 2.26-1.65 1.99-3.56-.24-1.74-1.61-3.21-3.35-3.47z"
  }),
  language: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  lock: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  logout: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  manage_accounts: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  schedule: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  thumb_up: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  calendar_today: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  check_circle_outline: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  dashboard: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M4 13h6c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v8c0 .55.45 1 1 1zm0 8h6c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1zm10 0h6c.55 0 1-.45 1-1v-8c0-.55-.45-1-1-1h-6c-.55 0-1 .45-1 1v8c0 .55.45 1 1 1zM13 4v4c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1h-6c-.55 0-1 .45-1 1z"
  }),
  event: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  filter_alt: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  lightbulb: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  list: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M4 13c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm0 4c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm0-8c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm4 4h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zm0 4h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zM7 8c0 .55.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1zm-3 5c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm0 4c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm0-8c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm4 4h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zm0 4h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zM7 8c0 .55.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1z"
  }),
  login: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M10.3,7.7L10.3,7.7c-0.39,0.39-0.39,1.01,0,1.4l1.9,1.9H3c-0.55,0-1,0.45-1,1v0c0,0.55,0.45,1,1,1h9.2l-1.9,1.9 c-0.39,0.39-0.39,1.01,0,1.4l0,0c0.39,0.39,1.01,0.39,1.4,0l3.59-3.59c0.39-0.39,0.39-1.02,0-1.41L11.7,7.7 C11.31,7.31,10.69,7.31,10.3,7.7z M20,19h-7c-0.55,0-1,0.45-1,1v0c0,0.55,0.45,1,1,1h7c1.1,0,2-0.9,2-2V5c0-1.1-0.9-2-2-2h-7 c-0.55,0-1,0.45-1,1v0c0,0.55,0.45,1,1,1h7V19z"
  }),
  question_answer: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  verified: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  visibility_off: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 6.5c2.76 0 5 2.24 5 5 0 .51-.1 1-.24 1.46l3.06 3.06c1.39-1.23 2.49-2.77 3.18-4.53C21.27 7.11 17 4 12 4c-1.27 0-2.49.2-3.64.57l2.17 2.17c.47-.14.96-.24 1.47-.24zM2.71 3.16c-.39.39-.39 1.02 0 1.41l1.97 1.97C3.06 7.83 1.77 9.53 1 11.5 2.73 15.89 7 19 12 19c1.52 0 2.97-.3 4.31-.82l2.72 2.72c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L4.13 3.16c-.39-.39-1.03-.39-1.42 0zM12 16.5c-2.76 0-5-2.24-5-5 0-.77.18-1.5.49-2.14l1.57 1.57c-.03.18-.06.37-.06.57 0 1.66 1.34 3 3 3 .2 0 .38-.03.57-.07L14.14 16c-.65.32-1.37.5-2.14.5zm2.97-5.33c-.15-1.4-1.25-2.49-2.64-2.64l2.64 2.64z"
  }),
  account_balance: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  article: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  date_range: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  help: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92c-.5.51-.86.97-1.04 1.69-.08.32-.13.68-.13 1.14h-2v-.5c0-.46.08-.9.22-1.31.2-.58.53-1.1.95-1.52l1.24-1.26c.46-.44.68-1.1.55-1.8-.13-.72-.69-1.33-1.39-1.53-1.11-.31-2.14.32-2.47 1.27-.12.37-.43.65-.82.65h-.3C8.4 9 8 8.44 8.16 7.88c.43-1.47 1.68-2.59 3.23-2.83 1.52-.24 2.97.55 3.87 1.8 1.18 1.63.83 3.38-.19 4.4z"
  }),
  highlight_off: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  open_in_new: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M18 19H6c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h5c.55 0 1-.45 1-1s-.45-1-1-1H5c-1.11 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-6c0-.55-.45-1-1-1s-1 .45-1 1v5c0 .55-.45 1-1 1zM14 4c0 .55.45 1 1 1h2.59l-9.13 9.13c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L19 6.41V9c0 .55.45 1 1 1s1-.45 1-1V4c0-.55-.45-1-1-1h-5c-.55 0-1 .45-1 1z"
  }),
  paid: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  perm_identity: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  shopping_bag: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  task_alt: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  trending_up: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  arrow_right_alt: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  assignment: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  build: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  credit_card: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  delete_outline: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  fact_check: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  history: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  pets: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  report_problem: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  star_rate: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  verified_user: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  print: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  invert_colors: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
  ...
  contact_support: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
...
/***/ "./src/components/global/atoms/Icon/lib/material/content.js":
/*!******************************************************************!*\
  !*** ./src/components/global/atoms/Icon/lib/material/content.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const content = {
  add_circle: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
...
/***/ "./src/components/global/atoms/Icon/lib/material/navigation.js":
/*!*********************************************************************!*\
  !*** ./src/components/global/atoms/Icon/lib/material/navigation.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const navigation = {
  chevron_right: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6-6-6z"
  }),
  more_horiz: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
...
/***/ "./src/components/global/atoms/Row/index.js":
/*!**************************************************!*\
  !*** ./src/components/global/atoms/Row/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.scss */ "./src/components/global/atoms/Row/styles.scss");
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_styles_scss__WEBPACK_IMPORTED_MODULE_1__);
...
/***/ "./src/components/global/atoms/Seo/index.js":
/*!**************************************************!*\
  !*** ./src/components/global/atoms/Seo/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var projectSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! projectSettings */ "./src/settings/project/res.pm/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_helmet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-helmet */ "./node_modules/react-helmet/es/Helmet.js");
/* harmony import */ var projectContent_static_images_open_graph_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! projectContent/static/images/open-graph.jpg */ "./content/res.pm/static/images/open-graph.jpg");
/* harmony import */ var projectContent_static_images_favicon_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! projectContent/static/images/favicon.png */ "./content/res.pm/static/images/favicon.png");
/* harmony import */ var projectContent_static_images_favicon_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! projectContent/static/images/favicon.svg */ "./content/res.pm/static/images/favicon.svg");
...
function Seo(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("html", {
    lang: "en"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, seoTitle), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("meta", {
    name: "description",
    content: description
    ...
    rel: "icon",
    href: projectContent_static_images_favicon_png__WEBPACK_IMPORTED_MODULE_4__["default"],
    type: "image/png"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("link", {
    rel: "icon",
    href: projectContent_static_images_favicon_svg__WEBPACK_IMPORTED_MODULE_5__["default"],
    type: "image/svg+xml"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("meta", {
    property: "og:title",
    content: seoTitle
    ...
    property: "og:image",
    content: `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteUrl}${projectContent_static_images_open_graph_jpg__WEBPACK_IMPORTED_MODULE_3__["default"]}`
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("meta", {
    property: "og:url",
    ...
    content: projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("meta", {
...
///
// options: {
//   language: base.siteDefaultLocale,
//   openGraph: {
//     type: "website",
//     locale: base.siteDefaultLocale,
//     url: seo.siteUrl,
...
/***/ "./src/components/global/atoms/ThemeSwitcher/index.js":
/*!************************************************************!*\
  !*** ./src/components/global/atoms/ThemeSwitcher/index.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! globalAtoms/Icon */ "./src/components/global/atoms/Icon/index.js");
...
function ThemeSwitcher(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_dark_mode__WEBPACK_IMPORTED_MODULE_1__.ThemeToggler, null, ({
    theme,
    toggleTheme
  }) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    className: props.className,
    icon: "invert_colors",
...
/***/ "./src/components/global/atoms/Video/index.js":
/*!****************************************************!*\
  !*** ./src/components/global/atoms/Video/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Video(props) {
  var _props$className, _props$type;

  const className = (_props$className = props.className) !== null && _props$className !== void 0 ? _props$className : "";
  const type = (_props$type = props.type) !== null && _props$type !== void 0 ? _props$type : "video/mp4";
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("video", {
    ...
    className: `${className} rounded aspect-w-16 aspect-h-9 w-full`
...
/***/ "./src/components/global/organisms/ElementList/index.js":
/*!**************************************************************!*\
  !*** ./src/components/global/organisms/ElementList/index.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ElementList)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.scss */ "./src/components/global/organisms/ElementList/styles.scss");
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_styles_scss__WEBPACK_IMPORTED_MODULE_1__);

 //import Row from "globalAtoms/Row"
...
function ElementList(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "element-section mt-6"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: `element-list ${props.listClassName}`,
    style: {
      boxShadow: `inset 0 1px 0 var(--separator-non-opaque),inset 0 -1px 0 var(--separator-non-opaque)`
    }
  }, children));
}
...
/***/ "./src/components/global/organisms/Layout/index.js":
/*!*********************************************************!*\
  !*** ./src/components/global/organisms/Layout/index.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var styles_global_index_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(styles_global_index_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _mdx_js_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mdx-js/react */ "./node_modules/@mdx-js/react/dist/esm.js");
/* harmony import */ var globalAtoms_Button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! globalAtoms/Button */ "./src/components/global/atoms/Button/index.js");
/* harmony import */ var globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! globalAtoms/Icon */ "./src/components/global/atoms/Icon/index.js");
/* harmony import */ var globalAtoms_Video__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! globalAtoms/Video */ "./src/components/global/atoms/Video/index.js");
...
function Layout(props) {
  const shortcodes = {
    Button: globalAtoms_Button__WEBPACK_IMPORTED_MODULE_3__["default"],
    Icon: globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_4__["default"],
    Video: globalAtoms_Video__WEBPACK_IMPORTED_MODULE_5__["default"]
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__.MDXProvider, {
...
/***/ "./src/components/project/res.pm/organisms/HomePageCover/index.js":
/*!************************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/HomePageCover/index.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HomePageCover)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var projectContent_static_images_authors_default_002_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! projectContent/static/images/authors/default/002.png */ "./content/res.pm/static/images/authors/default/002.png");


function HomePageCover(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: `flex justify-center relative ${props.className}`,
    style: props.style
  }, props.children, props.avatar && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "relative flex w-full max-w-screen-lg"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute z-10 flex items-center justify-center container max-w-full bottom-0 left-0"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
    src: projectContent_static_images_authors_default_002_png__WEBPACK_IMPORTED_MODULE_1__["default"],
    alt: "Blog author avatar",
    className: "absolute flex rounded-full z-10 w-32"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute flex rounded-full opacity-30 border border-solid border-background-primary",
    style: {
      width: "160px",
      height: "160px"
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute flex rounded-full opacity-20 border border-solid border-background-primary",
    style: {
      width: "192px",
      height: "192px"
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute flex rounded-full opacity-10 border border-solid border-background-primary",
    style: {
      width: "224px",
      height: "224px"
    }
  }))), props.bg !== false && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute flex w-full h-full bg-background-secondary overflow-hidden",
    style: props.styleBg
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
/***/ "./src/components/project/res.pm/organisms/MainNav/index.js":
/*!******************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/MainNav/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalAtoms/Icon */ "./src/components/global/atoms/Icon/index.js");
/* harmony import */ var globalAtoms_ThemeSwitcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! globalAtoms/ThemeSwitcher */ "./src/components/global/atoms/ThemeSwitcher/index.js");
 // Atoms
...
function MainNav(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex justify-center h-12 relative select-none print:hidden"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex justify-center text-hight-contrast w-full fixed z-20 bg-hight-contrast-reverse",
    style: {
      boxShadow: "inset 0px -1px 0px var(--separator-non-opaque)",
      backdropFilter: "saturate(180%) blur(16px)",
      backgroundColor: "rgb(var(--background-primary-rgb-inner)/90%)"
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", {
    className: `container flex items-center max-w-screen-lg h-12 ${props.className}`
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex justify-center md:justify-between h-12 items-center w-full large-subhead"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/",
    className: "flex h-full items-center whitespace-nowrap transition text-hight-contrast opacity-80 hover:opacity-100 hover:text-hight-contrast"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg",
    className: "fill-current text-hight-contrast"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", {
    d: "M13.3603 2L20.7919 14.8719L16.939 22L13.6065 16.2281L15.4747 12.7715L11.7748 13.0555L9.50735 9.12808L13.3603 2ZM11.9624 19.2519L7.98122 11.953L4 19.2519H11.9624Z"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "ml-3"
  }, "Artem Attvud")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/resume",
    className: "hidden md:flex h-full flex items-center transition text-hight-contrast opacity-80 hover:opacity-100 hover:text-hight-contrast"
  }, "Resume"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://www.linkedin.com/in/attvud",
    target: "blank",
    className: "hidden md:flex h-full flex items-center transition text-hight-contrast opacity-80 hover:opacity-100 hover:text-hight-contrast"
  }, "Recommendations"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/portfolio",
    className: "hidden md:flex h-full flex items-center transition text-hight-contrast opacity-80 hover:opacity-100 hover:text-hight-contrast"
  }, "Portfolio"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/contacts",
    className: "hidden md:flex h-full items-center transition text-hight-contrast opacity-80 hover:opacity-100 hover:text-hight-contrast"
  }, "Contacts"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "hidden md:flex transition opacity-80 hover:opacity-100"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_ThemeSwitcher__WEBPACK_IMPORTED_MODULE_2__["default"], {
    className: "fill-current text-hight-contrast"
  }))))));
}
...
/***/ "./src/components/project/res.pm/organisms/Sidebar/content-layers/header/default.js":
/*!******************************************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/Sidebar/content-layers/header/default.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HeaderContentLayerDefault)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalAtoms/Row */ "./src/components/global/atoms/Row/index.js");


function HeaderContentLayerDefault() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/***/ "./src/components/project/res.pm/organisms/Sidebar/content-layers/header/menu.js":
/*!***************************************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/Sidebar/content-layers/header/menu.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HeaderContentLayerMenu)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalAtoms/Row */ "./src/components/global/atoms/Row/index.js");
...
function HeaderContentLayerMenu() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-large"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "center-part"
...
/***/ "./src/components/project/res.pm/organisms/Sidebar/content-layers/main/default.js":
/*!****************************************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/Sidebar/content-layers/main/default.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MainContentLayerDefault)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalAtoms/Row */ "./src/components/global/atoms/Row/index.js");
/* harmony import */ var globalOrganisms_ElementList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! globalOrganisms/ElementList */ "./src/components/global/organisms/ElementList/index.js");



function MainContentLayerDefault(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalOrganisms_ElementList__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-medium"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/",
    className: "left-part px-16"
  }, "..."))));
}

/***/ }),

/***/ "./src/components/project/res.pm/organisms/Sidebar/content-layers/main/menu.js":
/*!*************************************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/Sidebar/content-layers/main/menu.js ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MainContentLayerMenu)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalAtoms/Row */ "./src/components/global/atoms/Row/index.js");
...
function MainContentLayerMenu() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalOrganisms_ElementList__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-medium"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/",
    className: "left-part px-4"
  }, "My way")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-medium"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/resume",
    className: "left-part px-4"
  }, "Resume")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-medium"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://www.linkedin.com/in/attvud",
    target: "blank",
    className: "left-part px-4"
  }, "Recommendations")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Row__WEBPACK_IMPORTED_MODULE_1__["default"], {
    className: "element-medium"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "/portfolio",
    className: "left-part px-4"
...
/***/ "./src/components/project/res.pm/organisms/Sidebar/index.js":
/*!******************************************************************!*\
  !*** ./src/components/project/res.pm/organisms/Sidebar/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var projectOrganisms_Sidebar_content_layers_header_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! projectOrganisms/Sidebar/content-layers/header/default */ "./src/components/project/res.pm/organisms/Sidebar/content-layers/header/default.js");
/* harmony import */ var projectOrganisms_Sidebar_content_layers_header_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! projectOrganisms/Sidebar/content-layers/header/menu */ "./src/components/project/res.pm/organisms/Sidebar/content-layers/header/menu.js");
/* harmony import */ var projectOrganisms_Sidebar_content_layers_main_default__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! projectOrganisms/Sidebar/content-layers/main/default */ "./src/components/project/res.pm/organisms/Sidebar/content-layers/main/default.js");
/* harmony import */ var projectOrganisms_Sidebar_content_layers_main_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! projectOrganisms/Sidebar/content-layers/main/menu */ "./src/components/project/res.pm/organisms/Sidebar/content-layers/main/menu.js");
/* harmony import */ var globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! globalAtoms/Icon */ "./src/components/global/atoms/Icon/index.js");
...
function Sidebar() {
  const {
    0: headerContentLayer,
    1: setHeaderContentLayer
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("default");
  const {
    0: mainContentLayer,
    1: setMainContentLayer
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("default");
  const {
    0: footerContentLayer,
    1: setFooterContentLayer
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("default");
  let sidebar, sidebarClassList;
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    sidebar = document.getElementById("main-sidebar-content");
  });

  function sidebarVisibilityHandler(neededContentLayer) {
    if (mainContentLayer !== neededContentLayer) {
      setHeaderContentLayer(neededContentLayer);
      setMainContentLayer(neededContentLayer);
      setFooterContentLayer(neededContentLayer);
    }

    if (mainContentLayer === neededContentLayer || sidebar.classList.contains("invisible") || sidebar.classList.contains("visible")) {
  ...
  function getHeaderContentLayer(headerContentLayer) {
    switch (headerContentLayer) {
      case "menu":
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_Sidebar_content_layers_header_menu__WEBPACK_IMPORTED_MODULE_2__["default"], null);

      default:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_Sidebar_content_layers_header_default__WEBPACK_IMPORTED_MODULE_1__["default"], null);
    }
  }

  function getMainContentLayer(mainContentLayer) {
    switch (mainContentLayer) {
      case "menu":
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_Sidebar_content_layers_main_menu__WEBPACK_IMPORTED_MODULE_4__["default"], null);

      default:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_Sidebar_content_layers_main_default__WEBPACK_IMPORTED_MODULE_3__["default"], null);
    }
  }

  function getFooterContentLayer(footerContentLayer) {
    switch (footerContentLayer) {
      // case "default":
      //   return <FooterContentLayerDefault />
      default:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
          ...
          href: "/"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_5__["default"], {
          icon: "home",
          className: "fill-current text-hight-contrast"
        }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
          className: "large-caption text-hight-contrast"
          ...
          onClick: event => {
            const neededContentLayer = "menu";
            sidebarVisibilityHandler(neededContentLayer);
          }
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Icon__WEBPACK_IMPORTED_MODULE_5__["default"], {
          icon: "more_horiz",
          className: "fill-current text-hight-contrast"
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("aside", {
    className: "flex md:hidden fixed flex-col z-30",
    style: {
      maxWidth: "360px"
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "fixed bg-background-secondary w-full h-screen invisible",
    style: {
      boxShadow: "1px 0px 0px var(--separator-non-opaque)",
      maxWidth: "360px"
    },
  ...
  }, getHeaderContentLayer(headerContentLayer)), getMainContentLayer(mainContentLayer)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("footer", {
    className: "grid grid-flow-col grid-cols-3 h-14 w-full fixed bottom-0 bg-background-primary print:hidden",
    style: {
      boxShadow: "inset 0px 1px 0px var(--separator-non-opaque)"
    }
  }, getFooterContentLayer(footerContentLayer)));
}

/***/ }),

/***/ "./src/components/project/res.pm/pages/index.js":
/*!******************************************************!*\
  !*** ./src/components/project/res.pm/pages/index.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var globalLibs_helpers_get_page_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! globalLibs/helpers/get-page-data */ "./src/libs/global/helpers/get-page-data.js");
/* harmony import */ var projectLibs_helpers_get_work_experience__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! projectLibs/helpers/get-work-experience */ "./src/libs/project/res.pm/helpers/get-work-experience.js");
/* harmony import */ var globalAtoms_Seo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! globalAtoms/Seo */ "./src/components/global/atoms/Seo/index.js");
/* harmony import */ var globalOrganisms_Layout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! globalOrganisms/Layout */ "./src/components/global/organisms/Layout/index.js");
/* harmony import */ var projectOrganisms_HomePageCover__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! projectOrganisms/HomePageCover */ "./src/components/project/res.pm/organisms/HomePageCover/index.js");
/* harmony import */ var projectOrganisms_Sidebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! projectOrganisms/Sidebar */ "./src/components/project/res.pm/organisms/Sidebar/index.js");
/* harmony import */ var projectOrganisms_MainNav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! projectOrganisms/MainNav */ "./src/components/project/res.pm/organisms/MainNav/index.js");
 // Libs
...
function IndexPage(props) {
  const pageData = (0,globalLibs_helpers_get_page_data__WEBPACK_IMPORTED_MODULE_1__["default"])(props);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalOrganisms_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
    className: "flex-col"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(globalAtoms_Seo__WEBPACK_IMPORTED_MODULE_3__["default"], {
    pageData: pageData
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_Sidebar__WEBPACK_IMPORTED_MODULE_6__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_MainNav__WEBPACK_IMPORTED_MODULE_7__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(projectOrganisms_HomePageCover__WEBPACK_IMPORTED_MODULE_5__["default"], {
    style: {
      height: "400px"
    },
    avatar: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex flex-col text-center absolute z-10 inset-0 text-hight-contrast",
    style: {
      top: "24%"
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "xxxLarge-high-title font-bold mb-4"
  }, "Lead UX/UI Designer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "xxxLarge-h1"
  }, "Middle Web Developer"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", {
    className: "container mx-auto max-w-screen-lg mt-32"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex justify-between items-end"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", {
    className: "m-0"
  }, "My way"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, (0,projectLibs_helpers_get_work_experience__WEBPACK_IMPORTED_MODULE_2__["default"])(), " years of experience")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2008 - 2015]"), " - Received education. Work on freelance exchanges. Cooperation with Ukrainian and Russian web studios."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2015 - 2016]"), " - Worked in a Belarusian web studio as Middle UX/UI Designer."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2016]"), " - Established cooperation with regular customers and distanced himself from freelance exchanges."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2017]"), " - I have developed my own design system. Deepened his knowledge in the field of user behavior analysis and conversion optimization for e-commerce sites. Learned HTML5, CSS3. Began to be responsible for quality control of Front-end development on several projects. Started working for Upwork."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2018]"), " - Began to specialize in the most complex projects. Developed UX/UI for mapping services in Ukraine and Belarus. Perfectly mastered Google and Apple Guidlines. Added a lot of patterns to my design system for developing mobile app design. Continued to work for Upwork."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2019]"), " - Deepened my knowledge in Front-end development. I started learning Java Script, React and Node JS. I transferred my design system from Sketch to Figma, significantly expanded its capabilities and applications. Refused to work for Upwork in favor of working with regular clients."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[2020]"), " - I wrote a component library in React for my design system. Moved most of my projects to my own codebase. I started working as a Team Lead in a team that was developing a design system for a number of microservices. Main responsibilities: component quality control, code review, minimizing the time spent on development."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-tint-foreground-purple"
  }, "[NOW]"), " - I continue to work as a Team Lead."))));
}

/***/ }),

/***/ "./src/libs/global/helpers/get-page-data.js":
/*!**************************************************!*\
  !*** ./src/libs/global/helpers/get-page-data.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getPageData(props) {
  ...
  const mdx = (_props$data = props.data) !== null && _props$data !== void 0 && _props$data.mdx ? props.data.mdx : null;
  const location = props !== null && props !== void 0 && props.location ? props.location : null; //

  const body = mdx === null || mdx === void 0 ? void 0 : mdx.body;
  const excerpt = mdx === null || mdx === void 0 ? void 0 : mdx.excerpt;
  const frontmatter = mdx === null || mdx === void 0 ? void 0 : mdx.frontmatter;
  const headings = mdx === null || mdx === void 0 ? void 0 : mdx.headings;
  const id = mdx === null || mdx === void 0 ? void 0 : mdx.id;
  const slug = mdx === null || mdx === void 0 ? void 0 : mdx.slug;
  const tableOfContents = mdx === null || mdx === void 0 ? void 0 : mdx.tableOfContents;
  const words = mdx === null || mdx === void 0 ? void 0 : mdx.words;
  const sentences = mdx === null || mdx === void 0 ? void 0 : mdx.sentences;
  const paragraphs = mdx === null || mdx === void 0 ? void 0 : mdx.paragraphs; // seo

  const path = location.pathname;
  const pageType = getPageType();
  const pageName = getPageName();
  const title = getPageTitle().pageTitle;
  let seoTitle = getPageTitle().pageSeoTitle;
  ...
  function getPageName() {
    let pageName = location.pathname.replace(/\//gi, "");
    if (pageName === "") pageName = "home";
    return pageName;
  }

  function getPageType() {
    if ((mdx === null || mdx === void 0 ? void 0 : mdx.frontmatter) === undefined) {
      return "static";
    } else {
      return "dynamic";
    }
  ...
  function getPageTitle() {
    let pageTitle, pageSeoTitle;

    for (const key in projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages) {
      if (pageName === key && pageType === "static") {
        pageTitle = projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages[pageName].title;
        pageSeoTitle = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages[pageName].title} - ${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix}`;
        if (pageName === "home") pageSeoTitle = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix}`;
      }
    }

    if (pageType === "dynamic") {
      pageTitle = mdx.frontmatter.title;
      pageSeoTitle = `${mdx.frontmatter.title} - ${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix}`;
    }

    if (pageTitle === undefined) {
      pageTitle = projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages.notFound.title;
      pageSeoTitle = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages.notFound.title} - ${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix}`;
    }
  ...
  function getPageDescription() {
    ...
    for (const key in projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages) {
      if (pageName === key && pageType === "static") {
        pageDescription = projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages[pageName].description;
      }
    }
    ...
    if (pageDescription === undefined) {
      pageDescription = projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages.notFound.description = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.pages.notFound.description} - ${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteSeoPrefix}`;
    }
  ...
  function getCanonicalUrl() {
    ...
    switch (path) {
      case "/":
        canonicalUrl = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteUrl}/`;
        break;

      default:
        canonicalUrl = `${projectSettings__WEBPACK_IMPORTED_MODULE_0__.seo.siteUrl}${path}`;
        break;
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getPageData);

/***/ }),

/***/ "./src/libs/project/res.pm/helpers/get-work-experience.js":
/*!****************************************************************!*\
  !*** ./src/libs/project/res.pm/helpers/get-work-experience.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getWorkExperience);

/***/ }),

/***/ "./src/settings/project/res.pm/base.js":
/*!*********************************************!*\
  !*** ./src/settings/project/res.pm/base.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {

const siteDefaultLocale = "ru"; // https://unicode-org.github.io/cldr-staging/charts/37/supplemental/territory_language_information.html

const siteDefaultTheme = "dark";
const sitePrecachedPages = ["/index", "/resume", "/portfolio", "/contacts"];
const siteModules = {
  portfolio: true,
  shop: false,
  blog: false,
...
/***/ "./src/settings/project/res.pm/blog.js":
/*!*********************************************!*\
  !*** ./src/settings/project/res.pm/blog.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/settings/project/res.pm/index.js":
/*!**********************************************!*\
  !*** ./src/settings/project/res.pm/index.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const {
  styleVariables
} = __webpack_require__(/*! ./style-variables */ "./src/settings/project/res.pm/style-variables.js");

const {
  pages
} = __webpack_require__(/*! ./pages */ "./src/settings/project/res.pm/pages.js");

const {
  base
} = __webpack_require__(/*! ./base */ "./src/settings/project/res.pm/base.js");

const {
  seo
} = __webpack_require__(/*! ./seo */ "./src/settings/project/res.pm/seo.js"); // Modules


const {
  portfolio
} = __webpack_require__(/*! ./portfolio */ "./src/settings/project/res.pm/portfolio.js");

const {
  shop
} = __webpack_require__(/*! ./shop */ "./src/settings/project/res.pm/shop.js");

const {
  blog
} = __webpack_require__(/*! ./blog */ "./src/settings/project/res.pm/blog.js");

exports.styleVariables = styleVariables;
exports.pages = pages;
exports.base = base;
exports.seo = seo; // Modules
...
/***/ "./src/settings/project/res.pm/pages.js":
/*!**********************************************!*\
  !*** ./src/settings/project/res.pm/pages.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const {
  seo
} = __webpack_require__(/*! ./seo */ "./src/settings/project/res.pm/seo.js");
...
exports.pages = {
  ...
  home: {
    title: seo.siteSeoPrefix,
    description: "..."
  },
  portfolio: {
    title: "Portfolio",
    description: "I have posted less than 10% of my works. You can contact me for more examples."
  },
  resume: {
    title: "Resume",
    description: "I have been working as a UX / UI designer since 2005. Since the end of 2018, in order to create and support my own projects, and began to learn programming. Currently I work as a Lead UX / UI designer (I only take on the most complex projects)."
  }
};

/***/ }),

/***/ "./src/settings/project/res.pm/portfolio.js":
/*!**************************************************!*\
  !*** ./src/settings/project/res.pm/portfolio.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports.portfolio = {
  categories: {
    default: {
      title: "Default portfolio category",
      description: "",
      link: "default",
      cover: ""
    }
...
/***/ "./src/settings/project/res.pm/seo.js":
/*!********************************************!*\
  !*** ./src/settings/project/res.pm/seo.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {

const siteUrl = "https://res.pm";
const sitePathPrefix = "res.pm";
const siteUrlWithSlash = `${siteUrl}/`;
const siteName = "Artem Attvud";
const siteShortName = "Artem A.";
const siteShortDescription = "Lead UX/UI Designer & Middle Web Developer";
const siteSeoDivider = "|";
const siteSeoPrefix = `${siteName} ${siteSeoDivider} ${siteShortDescription}`;
exports.seo = {
  siteUrl,
  siteUrlWithSlash,
  siteName,
...
/***/ "./src/settings/project/res.pm/shop.js":
/*!*********************************************!*\
  !*** ./src/settings/project/res.pm/shop.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {

const defaultProductWarrantyText = "";
exports.shop = {
  defaultProductWarrantyText,
  categories: {
    default: {
      title: "Default shop category",
      description: "",
      link: "default",
      cover: "",
      warrantyText: ""
...
/***/ "./src/settings/project/res.pm/style-variables.js":
/*!********************************************************!*\
  !*** ./src/settings/project/res.pm/style-variables.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports) => {

exports.styleVariables = {
  borderRadius: {
    primary: "4px",
    secondary: "8px",
    tertiary: "16px"
...
/***/ "./src/components/global/atoms/Button/styles/index.scss":
/*!**************************************************************!*\
  !*** ./src/components/global/atoms/Button/styles/index.scss ***!
  \**************************************************************/
/***/ (() => {
...
/***/ "./src/components/global/atoms/Icon/styles.scss":
/*!******************************************************!*\
  !*** ./src/components/global/atoms/Icon/styles.scss ***!
  \******************************************************/
/***/ (() => {
...
/***/ "./src/components/global/atoms/Row/styles.scss":
/*!*****************************************************!*\
  !*** ./src/components/global/atoms/Row/styles.scss ***!
  \*****************************************************/
/***/ (() => {
...
/***/ "./src/components/global/organisms/ElementList/styles.scss":
/*!*****************************************************************!*\
  !*** ./src/components/global/organisms/ElementList/styles.scss ***!
  \*****************************************************************/
/***/ (() => {
...
/***/ "./content/res.pm/static/images/authors/default/002.png":
/*!**************************************************************!*\
  !*** ./content/res.pm/static/images/authors/default/002.png ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "static/002-31ec70c17b835e49250accc326eada6a.png");

/***/ }),

/***/ "./content/res.pm/static/images/favicon.png":
/*!**************************************************!*\
  !*** ./content/res.pm/static/images/favicon.png ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/png;base64,");

/***/ }),

/***/ "./content/res.pm/static/images/favicon.svg":
/*!**************************************************!*\
  !*** ./content/res.pm/static/images/favicon.svg ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/svg+xml;base64,");

/***/ }),

/***/ "./content/res.pm/static/images/open-graph.jpg":
/*!*****************************************************!*\
  !*** ./content/res.pm/static/images/open-graph.jpg ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "static/open-graph-fd47211ed50aef9ec995b62caa5e9fc4.jpg");

/***/ }),

/***/ "react-dom/server":
/*!***********************************************************************************************!*\
  !*** external "D:\\projects\\_source code\\gatsby-sites\\node_modules\\react-dom\\server.js" ***!
  \***********************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("D:\\projects\\_source code\\gatsby-sites\\node_modules\\react-dom\\server.js");
